      ...
      <form action='{{url('mahasiswa/'.$data->nim ) }}' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='tmptlhr' value="{{ $data->tmptlhr}}" id="tmptlhr">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='tgllhr' value="{{ $data->tgllhr}}" id="tgllhr">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='lamastudi' value="{{ $data->lamastudi}}" id="lamastudi">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label">IPK</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='ipk' value="{{ $data->ipk}}" id="ipk">
                </div>
            </div>
            <div class="mb-3 row">
